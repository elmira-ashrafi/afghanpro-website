...
@section('title', 'ایجاد نمایندگی جدید')

@section('page-title', 'ایجاد نمایندگی جدید')
    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">افزودن نمایندگی</h5>
            ...
            <div class="card-body">
                <form action="{{ route('dashboard.admin.agencies.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            @php
                                $workingHours = old('working_hours', [
